...
- **Zero Runtime JavaScript**: All pages are fully static. No client-side hydration is needed for content pages. Client components (theme toggle) are isolated and lazy.
